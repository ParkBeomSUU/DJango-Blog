...
class TestView(TestCase) :
    ...
    def test_create_post(self):
        #로그인하지 않으면 status code가 200이 안된다.
        response=self.client.get('/blog/create_post/')
        self.assertNotEqual(response.status_code,200)

        #staff가 아닌 트럼프가 로그인한다.
    ...
    def test_comment_update(self):
        ...
        comment_area = soup.find('div', id='comment-area')
        self.assertFalse(comment_area.find('a',id='commit-1-update-btn'))
        self.assertFalse(comment_area.find('a',id='commit-2-update-btn'))
    ...
    def test_delete_comment(self):
        ...
        comment_area = soup.find('div', id='comment-area')
        self.assertFalse(comment_area.find('a', id='commit-1-delete-btn'))
        self.assertFalse(comment_area.find('a', id='commit-2-delete-btn'))
